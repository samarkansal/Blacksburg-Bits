...
public class ApiResource {
    ...
    public Category categoryByName(
        ...
        try {
            ...
            throw new ApiException("Category lookup via categoryName failed", e);
        }
    }
    ...
    public List<Book> booksByCategoryName(
            ...
            @Context HttpServletRequest httpRequest) {
        try {
            return categoryDao.findBooksByCategoryName(categoryName);
        } catch (Exception e) {
    ...
    public List<Book> suggestedBooksByCategoryName(@PathParam("category-name") String categoryName,
                                     ...
                                     @Context HttpServletRequest request) {
        try {
            return categoryDao.findRandomBooksByCategoryName(categoryName, limit);
        } catch (Exception e) {
            throw new ApiException("products lookup via categoryName failed", e);
        }
    }
